...
alter table espacio_academico alter column no_salon set not null;
...
select*from espacio_academico;
select * from universidad;
select * from campus;

update campus set id_campus=2 where id_campus=5;
update edificio set id_edificio=2 where id_edificio=3;
